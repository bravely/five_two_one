defmodule FiveTwoOneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FiveTwoOneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FiveTwoOneWeb.Gettext, "errors", msg, opts)
    end
  end
